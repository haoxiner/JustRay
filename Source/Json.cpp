...
#include <cctype>
#include <iostream>
const JustRay::Json::JsonValue JustRay::Json::JsonValue::NULL_OBJECT;

JustRay::Json::JsonValue::JsonValue() : type_(JSON_NULL), data_({ false })
{
}

JustRay::Json::JsonValue::JsonValue(float number) : type_(JSON_NUMBER), data_({ number })
{
}

JustRay::Json::JsonValue::JsonValue(bool boolean) : type_(JSON_BOOLEAN), data_({ boolean })
{
}

JustRay::Json::JsonValue::JsonValue(char* str) : type_(JSON_STRING), data_({ str })
{
}

JustRay::Json::JsonValue::JsonValue(JsonObject* object) : type_(JSON_OBJECT), data_({ object })
{
}

void JustRay::Json::JsonValue::Destroy()
{
...
int JustRay::Json::JsonValue::AsInt() const
{
...
bool JustRay::Json::JsonValue::AsBool() const
{
    return data_.boolean;
}

float JustRay::Json::JsonValue::AsFloat() const
{
    if (type_ == JSON_NUMBER) {
        return data_.number;
    }
...
JustRay::Float2 JustRay::Json::JsonValue::AsFloat2() const
{
...
JustRay::Float3 JustRay::Json::JsonValue::AsFloat3() const
{
...
JustRay::Float4 JustRay::Json::JsonValue::AsFloat4() const
{
...
JustRay::Matrix4x4 JustRay::Json::JsonValue::AsMatrix4x4() const
{
...
std::string JustRay::Json::JsonValue::AsString() const
{
    switch (type_) {
    case JustRay::Json::JSON_NULL:
        return std::string("null");
        break;
    case JustRay::Json::JSON_BOOLEAN:
        return std::to_string(data_.boolean);
        break;
    case JustRay::Json::JSON_NUMBER:
        return std::to_string(data_.number);
        break;
    case JustRay::Json::JSON_STRING:
        return std::string(data_.str);
        break;
    case JustRay::Json::JSON_OBJECT:
        return std::string("JSON_OBJECT");
        break;
    case JustRay::Json::JSON_ARRAY:
    default:
...
const JustRay::Json::JsonValue* JustRay::Json::JsonValue::AsJsonArray() const
{
    if (type_ >= JSON_ARRAY) {
...
const JustRay::Json::JsonObject* JustRay::Json::JsonValue::AsJsonObject() const
{
...
JustRay::Json::JsonObject::~JsonObject()
{
...
const JustRay::Json::JsonValue& JustRay::Json::JsonObject::GetValue(const std::string& key) const
{
...
JustRay::Json::Parser::Parser(JsonObject* jsonObject, const char* json, const size_t length)
    : json_(json), length_(length), jsonObject_(jsonObject)
{
    Parse();
}

JustRay::Json::Parser::Parser(JsonObject* jsonObject, const std::string& json)
    : json_(json.c_str()), length_(json.length()), jsonObject_(jsonObject)
{
    Parse();
}

void JustRay::Json::Parser::Parse()
{
    ch_ = json_[0];
...
void JustRay::Json::Parser::SubmitError()
{
    if (!hasError_) {
        hasError_ = true;
...
bool JustRay::Json::Parser::HasError()
{
    return hasError_;
}

std::string JustRay::Json::Parser::GetErrorMessage() const
{
    return errorMessage_;
}

bool JustRay::Json::Parser::Forward()
{
...
void JustRay::Json::Parser::Forward(size_t count)
{
...
bool JustRay::Json::Parser::SkipSpaces()
{
    bool found = false;
    if (std::isspace(ch_)) {
        found = true;
...
bool JustRay::Json::Parser::SkipComments()
{
    bool found = false;
    if (ch_ == '/') {
        if (Forward() && ch_ == '/') {
...
void JustRay::Json::Parser::SkipSpacesAndComments()
{
...
void JustRay::Json::Parser::ParseObject(JsonObject* object)
{
    if (ch_ != '{') {
        SubmitError();
        return;
...
void JustRay::Json::Parser::ParseBoolean(JsonValue& value)
{
    if (ch_ == 't') {
        if (Forward() && ch_ == 'r') {
            if (Forward() && ch_ == 'u') {
...
void JustRay::Json::Parser::ParseValue(JsonValue& value)
{
    if (ch_ == '"') {
...
void JustRay::Json::Parser::ParseNumber(JsonValue& value)
{
...
void JustRay::Json::Parser::ParseArray(JsonValue& value)
{
    if (ch_ != '[') {
        SubmitError();
        return;
...
std::string JustRay::Json::Parser::ParseString()
{
    if (ch_ != '"') {
        SubmitError();
        return "";
